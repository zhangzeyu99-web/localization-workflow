...
def _make_prompt_header(lang: str = "en") -> str:
    ...
    return (
        ...
        "Do not abbreviate profession, resource, item, skill, shop, search-result, message, mail, content, contribution, placement, or equipment words into fragments such as Doct, Ener Scie, Stru Expe, Smel Expe, Pts impr esse, Res., No sear resu, Fast Trac Bull, Fina ATK SPD, Repl This mess expi, No unre mess, Hara swip spam mess, Inte guid, Glor Cont, Cont cann empt, Your cont ##1, Loca cann plac, Wear equi cann rese, No wear equi, or Stro equi Pack.\n"
